...
inline fun ViewPropertyAnimator.animationEnd(
    crossinline f: (Animator) -> Unit): ViewPropertyAnimator =
...
inline fun <reified T> animationUpdate(
    crossinline f: (T) -> Unit): ValueAnimator.AnimatorUpdateListener =
...
inline fun <T> T.animateFloat(from: Float, to: Float,
    crossinline f: T.(Float) -> Unit): ValueAnimator =
...
fun animateFloat(from: Float, to: Float): ValueAnimator =
    ValueAnimator.ofFloat(from, to)
